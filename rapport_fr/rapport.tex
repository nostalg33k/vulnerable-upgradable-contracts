...
\begin{itemize}
\item Il peut être transféré sur Internet sans duplication de pair-à-pair, de plus il a les caractéristiques des cryptomonnaies : infalsifiabilité, enregistrement des échanges dans un registre immuable, sécurité des échanges, etc.
